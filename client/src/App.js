...
import AllOrders from './pages/Middleman/AllOrders';
import AllUsersUnderLocation from './pages/Middleman/AllUsersUnderLocation';
    ...
    <> 
      <Routes>
        ...
        <Route path="/dashboard" element={<MiddleManRoute/>}>
                ...
                <Route path="middleman/allusersunderlocation" element={<AllUsersUnderLocation/>} />
                <Route path="middleman/AllOrders" element={<AllOrders/>} />        
        </Route>
